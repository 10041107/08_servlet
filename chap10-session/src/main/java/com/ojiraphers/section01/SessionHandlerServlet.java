...
public class SessionHandlerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        HttpSession은 직접 생서하는 것이 아닌 request에 있는 getSession()메소드를 이용하여 리턴을 받아 사용한다.

         */

        HttpSession session = req.getSession(); // req세션 : 사용자가 서버에 요청을 날렸을때 ~ 응답하기 전 부분
        ...
        session.setAttribute("firstName", firstName); // 세션에 저장을 한다 (사용자 정보를)
